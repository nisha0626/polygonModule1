...
async function main() {
  ...
  // Create a wallet instance using the private key and providerrR
  ...
  const NFT = await ethers.getContractFactory("Nisha");
  const nft = await NFT.attach("0xB5C590e5a4766991DD20aaB6A371D982480fB300");
