...
// Asynchronous main function to deploy the Nisha contract
async function main() {
  // Get the contract factory (ABI and bytecode) using the contract name "Nisha"
  const NFT = await hre.ethers.getContractFactory("Nisha");
